...
> **구현 현황 (09-21)**: §3의 inbox·send·ack·whoami API는 8024 송신/inbox 확장(1단계, 이사님 승인·구현 예정)
> spec이다. 현재 가동 중인 것은 이력 수집(수동발행→/comm 표시)까지. 단계 전환시 본 문서가 정본.
> 98(heav_lnx_codex_dev_1_bot)이 구현·전환 완료마다 이 섹션의 현황문을 갱신한다.
