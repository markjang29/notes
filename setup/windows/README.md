...
현재 운영 Git repo 기준은 4개다.

- `notes` — 원칙·ADR·work-queue·체크포인트
- `autotrader` — 자동매매/백테스트
- `rpg_game` — 전술 RPG
- `scenario` — 시나리오/RISU 자산·자생 서사
...
git author, notes·projects repos 4개(`notes`, `autotrader`, `rpg_game`, `scenario`), plugin(명령 재설치).
