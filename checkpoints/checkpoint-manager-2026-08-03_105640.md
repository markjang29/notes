...
- 시각: 2026-08-03 10:56:40 KST
- 모드: check
- 측정: 📊 glm-5.2[1m] | 한계 1,000,000 | 860,659 (86.1%) | 4.9MB
- 퍼센트: 86.1%
...
status:
log:
cb18551 feat(novel_assets): WHY-NEXT 카드 인과 검증 게이트 (이사님 비전 강화)
ce04707 docs: WHY-NEXT 카드 — 인과 연쇄 검증 템플릿 (수집 품질 기준)
