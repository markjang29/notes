...
- 시각: 2026-08-21 22:24:38 KST
- 모드: check
- 측정: 📊 glm-5.3[1m] | 한계 1,000,000 | 842,574 (84.3%) | 20.2MB
- 퍼센트: 84.3%
...
log:
241f4f7 docs(archmap): 건물 하위 세분화(submodules) — 6개 주요 건물 실측 내역
120f4b4 docs(archmap): fleet 맵 정본 — 7개 repo 20노드·10엣지(전부 grep 실측)·4플로우
e5f2b03 docs(archmap): 엣지 실측 검증 — 허위 3종(e1/e10/e11)·Night Batch 제거
